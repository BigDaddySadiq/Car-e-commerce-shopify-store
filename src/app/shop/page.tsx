        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-12">
          {PRODUCTS.map((prod, i) => (
            ...
            >
              ...
              <div className="relative w-full h-[260px] bg-black overflow-hidden border-b border-white/[0.04]">
                <video src={prod.video} autoPlay loop muted playsInline className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </div>
