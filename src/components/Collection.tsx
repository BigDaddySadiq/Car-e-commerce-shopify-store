...
export default function Collection() {
 ...
 return (
   <section id="the-cars" className="bg-[#080808] px-4 sm:px-6 py-[72px] md:px-[8vw] md:py-[120px] flex flex-col items-center">
     <p className="font-inter text-[11px] tracking-[5px] text-[#E8000D] uppercase text-center mb-6">CHOOSE YOUR FIRST STEP</p>
     <h2 className="font-bebas text-[46px] md:text-[80px] leading-none mb-10 md:mb-16 tracking-[-1px] md:tracking-[-2px] text-center uppercase bg-[linear-gradient(180deg,#FFFFFF_0%,#6A6A6A_100%)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">YOUR COLLECTION</h2>
       ...
       {PRODUCTS.map((prod, i) => (
         ...
         >
           ...
           <div className="relative w-full h-[220px] sm:h-[260px] bg-black overflow-hidden">
             <LazyProductVideo src={prod.video} poster={prod.poster} ariaLabel={`${prod.name} showcase`} className="w-full h-full object-cover" />
           </div>
           {/* Body */}
